    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading
              ? "Mohon Tunggu ..." : editId ? "Simpan Perubahan" : "Tambah Data" }
          </button>
          {editId && (
            <button
              type="button"
              ...
              className="ml-3 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold
                  ...
                  <td className="px-6 py-4 max-w-xs">
                    <div className="truncate text-gray-600">
                      ...
                      <button
                        ...
                        disabled={loading}
                      >
                        <AiFillEdit className="text-blue-500 text-2xl hover:text-green-700 transition-colors" />
                      </button>
                      ...
                      <button
                        ...
                        disabled={loading}
                      >
                        <AiFillDelete className="text-red-400 text-2xl hover:text-green-600 transition-colors" />
                      </button>
                    </div>
                  </td>
                </>
